...
class Config:
    ...
    # Bayesian PRM configs
    #n_classes: int = 1000
    #hidden_dims: List[int] = list = [ 1000 ]
    #backbone_model_name: str = "RLHFlow/Llama3.1-8B-PRM-Deepseek-Data"
    backbone_model_name: str = "HuggingFaceTB/SmolLM-1.7B-Instruct"
