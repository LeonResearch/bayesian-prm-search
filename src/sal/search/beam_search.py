...
def _beam_search(batch_of_prompts, config: Config, llm: LLM, prm: PRM) -> list[Beam]:
    ...
    for i in tqdm(range(config.num_iterations), desc="Beam search iterations"):
        ...
        # Note that our Bayes-PRM only generates a single score per partial-solution,
        # while the previous implemention also generates scores for all intermediate steps.
